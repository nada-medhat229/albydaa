<template>
  ...
  <div class="flex justify-between items-center mb-8 sm:text-2xl text-base text-[#10526B] font-semibold mx-2">
    <div>حقيبة سراج الأهلة : رمضان والعيد</div>
    <div>1445 هجريا</div>
  </div>
  <div class="bg-[#c7e0dcc7] py-3 sm:px-8 px-2 rounded-lg text-[#868686]  font-semibold sm:text-xl text-base flex justify-between items-center mx-2">
    <div class=" ">للكاتبة: د. هيفاء بنت ناصر الرشيد</div>
...
<div class="relative md:mx-0 mx-1">
  ...
  <section class="container mx-1">
    ...
    <div class="bg-[#c4c4c429] rounded-xl sm:px-4 py-10">
      <div
        ...
        class="mb-5"
      >
        <p class="sm:text-xl text-base font-semibold leading-relaxed lg:px-16 px-6">{{ text.text }}</p>
      </div>
    </div>
  </section>

  <div class="flex sm:justify-between justify-center mt-4 absolute sm:top-[50%] w-full">
    <button
      @click="prevPage"
